...
The RFC (Section 5) describes the driver as "not a simple deserializer -- it is an opinionated renderer that makes decisions about how to present context to maximize model comprehension within a token budget."
